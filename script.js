...
// ==================== JAVA НЕГІЗДЕРІ СҰРАҚТАРЫ (150 сұрақ) ====================
const QUESTIONS = [
  ...
  {question:"default...", options:["for","if","else","switch","try"], correct:3},
  ...
  {question:"Конструктор қайсы?", options:["return бар","void типті","Атауы класс атымен бірдей","Екі еселі","Кез келген сөз"], correct:2},
  {question:"this не істейді?", options:["Сыртқы класс","Ағымдағы объектті білдіреді","Жаңа объект","Интерфейс","Пакет"], correct:1},
  {question:"super не істейді?", options:["Жаңа объект","Ата-аналық класқа қол жеткізу","Пакет қосу","Массив","Конкатенация"], correct:1},
  {question:"final кілт сөзі", options:["Массив құрады","Өзгермейтін етеді","Көбейту","Түсініктеме","static сияқты"], correct:1},
  ...
  {question:"try не үшін?", options:["Цикл","Қате болуы мүмкін код жазу","Массив","Класс","Объект жасау"], correct:1},
  ...
  {question:"JDBC не үшін?", options:["Файл оқу","Массив","Дерекқормен жұмыс (Java Database Connectivity)","GUI","HashMap"], correct:2},
  {question:"JDBC драйвері не істейді?", options:["Массив жасайды","Java мен дерекқорды байланыстырады","Пакет ашады","Цикл жасайды","Exception"], correct:1},
  {question:"SQL сұрауын орындау объектісі?", options:["Driver","Connection","Statement","Array","String"], correct:2},
  {question:"PreparedStatement артықшылығы?", options:["Жылдам емес","SQL Injection қорғаныс + жылдамдық","Файл ашады","Цикл құрады","Пакет"], correct:1},
  {question:"ResultSet не істейді?", options:["Жазады","Нәтижені қайтарады (select)","Пакет","Массив","Цикл"], correct:1},
  {question:"Java-да override жасау үшін қандай аннотация?", options:["@Static","@Final","@Override","@Public","@Super"], correct:2},
  {question:"@Deprecated не үшін?", options:["Түсініктеме","Ескі код, қолданбау керек","Массив","Файл","Интерфейс"], correct:1},
  {question:"@FunctionalInterface дегеніміз", options:["Класс","Scanner","Бір ғана абстракт әдісі бар интерфейс","Пакет","Цикл"], correct:2},
  {question:"Lambda expression қай версиядан?", options:["Java 5","Java 6","Java 7","Java 8","Java 10"], correct:3},
  {question:"Lambda синтаксисі", options:["[] -> {}","() -> {}","{} –> ()","<> -> ()","() => {}"], correct:1},
  {question:"Stream API қайда қолданылады?", options:["SQL","Коллекциялармен функционалды жұмыс","Пакет","Файл","Цикл"], correct:1},
  {question:"Stream.filter() не істейді?", options:["Көбейту","Элементтерді сүзу","Сорттау","Жою","Пакет"], correct:1},
  {question:"Stream.map()", options:["Жою","Түрлендіру","Конкатенация","Қосу","Пакет"], correct:1},
  {question:"Optional не үшін керек?", options:["Массив","NullPointerException алдын алу","Цикл","SQL","Қате"], correct:1},
  {question:"Optional.get() не істейді?", options:["Массив","Мәнді қайтарады","HashMap","Boolean","Пакет"], correct:1},
  {question:"Optional.isPresent()", options:["Жою","Мән бар-жоғын тексеру","Қосу","Пакет","Класс"], correct:1},
  {question:"Collections.sort() не істейді?", options:["Қосу","Тізімді сұрыптайды","HashMap","Массив","Конструктор"], correct:1},
  {question:"Comparator қайда қолданылады?", options:["Scanner","HashMap","Сұрыптау логикасын жазу","File","Enum"], correct:2},
  {question:"Comparable интерфейсі не үшін?", options:["Конструктор","Файл","Табиғи сұрыптау","Цикл","Жүйе"], correct:2},
  {question:"Serialization не?", options:["Файл ашу","SQL","Объектіні байт түріне айналдыру","Цикл","Scanner"], correct:2},
  {question:"Serializable интерфейсі", options:["Метод бар","Бос интерфейс (marker interface)","Конструктор","Пакет","Цикл"], correct:1},
  {question:"transient не үшін?", options:["Сақтайды","Сериализациядан жасырады","Көбейту","Массив","SQL"], correct:1},
  {question:"File класы қай пакетте?", options:["java.math","java.io","java.util","java.sql","java.awt"], correct:1},
  {question:"Math.random() не қайтарады?", options:["int","double (0–1)","long","boolean","char"], correct:1},
  {question:"Math.sqrt()", options:["Куб","Түбір (квадрат түбір)","Бөлшек","Қосу","Массив"], correct:1},
  {question:"System.currentTimeMillis()", options:["Файл ашады","Scanner","Уақытты миллисекундпен қайтарады","SQL","Цикл"], correct:2},
  {question:"LocalDate қай пакетте?", options:["java.io","java.util","java.time","java.sql","java.lang"], correct:2},
  {question:"LocalDate.now()", options:["Уақыт","Файл","Бүгінгі күн","Boolean","Массив"], correct:2},
  {question:"toString() не істейді?", options:["Жояды","Объектінің мәтіндік көрінісін қайтарады","Цикл","SQL","Scanner"], correct:1},
  {question:"equals() пен == айырмасы?", options:["Екеуі бірдей","equals – мәнді салыстырады, == – сілтемені","== күштірек","equals тек массивке","Екеуі тек сандарға"], correct:1},
  {question:"String immutable болуы", options:["Өзгермелі","Өзгермейді (immutable)","Қосылады","Жояды","Массив"], correct:1},
  {question:"StringBuilder қандай?", options:["Immutable","Mutable (өзгермелі)","Мәңгілік","Массив","HashMap"], correct:1},
  {question:"StringBuilder артықшылығы", options:["Баяу","Жылдам өзгерту","Тек сандар","Файл","SQL"], correct:1},
  {question:"append()", options:["Жою","Көбейту","Соңына қосу","Массив","Пакет"], correct:2},
  {question:"delete()", options:["Қосу","Жою","Сұрыптау","Цикл","HashMap"], correct:1},
  {question:"ООП принципі емес қайсысы?", options:["Инкапсуляция","Полиморфизм","Мұрагерлік","Компиляция","Абстракция"], correct:3},
  {question:"ООП-да деректерді жасыру?", options:["Полиморфизм","Инкапсуляция","Массив","Цикл","Пакет"], correct:1},
  {question:"Абстракция дегеніміз?", options:["Массив","Маңызды қасиеттерді бөліп көрсету","Көбейту","Пакет","Exception"], correct:1},
  {question:"Java-да көп мұрагерлік бар ма?", options:["Иә","Жоқ (тек интерфейстер арқылы)","Массив","SQL","Цикл"], correct:1},
  {question:"IDE дегеніміз?", options:["Тек консоль","Бағдарлама жазу ортасы","Пакет","Файл","Массив"], correct:1},
  {question:"IntelliJ IDEA не?", options:["Дерекқор","Сервер","Java IDE","Массив","GUI"], correct:2},
  {question:"Eclipse не?", options:["SQL","Java IDE","Пакет","Файл","Массив"], correct:1},
  {question:"Git не үшін?", options:["Файл ашу","Нұсқа бақылау жүйесі","SQL","Массив","Цикл"], correct:1},
  {question:"GitHub не?", options:["IDE","SQL сервер","Код сақтау платформасы","Цикл","JVM"], correct:2},
  {question:"JVM қай тілде жұмыс істейді?", options:["Машиналық","Ассемблер","Bytecode (.class)","Python","C++"], correct:2},
  {question:"Bytecode не?", options:["Java бастапқы код","JVM орындайтын аралық код","SQL","Массив","Файл"], correct:1},
  {question:"JAR файл?", options:["Тек сурет","Java архиві","SQL","Txt","Пакет"], correct:1},
  {question:"Java — platform…", options:["Тәуелді","Тәуелсіз (write once run anywhere)","Шектеулі","Файл","IDE"], correct:1},
  {question:"Garbage Collector не істейді?", options:["Код жазады","Көбейту","Қолданылмайтын объектілерді жояды","Массив","HashMap"], correct:2},
  {question:"Memory leak дегеніміз?", options:["Файл ашу","Пакет","Жадтың босатылмай қалуы","Массив","Цикл"], correct:2}
];
